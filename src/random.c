...
static void random_bytes(void *out, size_t len, tiimat3_Seed *seed);
...
static void
random_bytes(void *out, size_t len, tiimat3_Seed *seed)
{
	unsigned char *ptr, *s;
	size_t unused, i;
...
void
tiimat3_random_bytes(unsigned char *out, size_t len, tiimat3_Seed *seed)
{
...
void
tiimat3_random_cbd1_i8(int8_t *out, size_t len, tiimat3_Seed *seed)
{
	size_t i;
...
void
tiimat3_random_cbd1_i64(int64_t *out, size_t len, tiimat3_Seed *seed)
{
	size_t i;
...
void
tiimat3_random_cbd21_i8(int8_t *out, size_t len, tiimat3_Seed *seed)
{
	size_t i;
...
void
tiimat3_random_cbd21_i64(int64_t *out, size_t len, tiimat3_Seed *seed)
{
	size_t i;
...
void
tiimat3_random_uniform_i64(int64_t *out, size_t len, uint64_t mod, tiimat3_Seed *seed)
{

	tiimat3_random_uniform_u64((uint64_t *)out, len, mod, seed);
}

void
tiimat3_random_uniform_u64(uint64_t *out, size_t len, uint64_t mod, tiimat3_Seed *seed)
{
	uint64_t mask;
	size_t i;
